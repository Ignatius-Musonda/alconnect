            ...
            <div className='resNav'>
                ...
                <div className='listItems'>
                    ...
                    <div className='thirdItem'> 
                        ...
                        <li>
                                ...
                                {/* Bookings */}
                                    {/* <Link to={"/login"} className='linkItem'><button>LOGIN</button></Link> */}
                                    <FontAwesomeIcon className='fontawesomIcons' icon={faShoppingCart}></FontAwesomeIcon>
                ...
                <div className= {navDropSec?'SecResDrop':"noSecDrop"}>
                    <div className='secDropCover'>
                                ...
                                <ul>
                                    <li><Link to={"/"} className='linkItem'>Courses</Link></li>
                                    <li><Link to={"/"} className='linkItem'>For Organizations</Link></li>
                                    <li><Link to={"/"} className='linkItem'>Insights</Link></li>
                                    <li><Link to={"/"} className='linkItem'>More Info</Link></li>
                                    <li><Link to={"/"} className='linkItem'>Alumni</Link></li>
                                   
                                    <li><Link to={"/"} className='linkItem'><button>APPLY NOW</button></Link></li>
